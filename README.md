...
For example, suppose you have a device called "lamp". You could generate a "turn on lamp" sentence and have Piper forward that instead of generating the sentence on the fly.
...
```json
{
  "turn on lamp": "on/lamp.wav",
  "turn off heating": "off/heating.wav"
}
```
